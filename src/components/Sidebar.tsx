...
import { LayoutDashboard, MessageSquare, Users2, BarChart3, Settings2, HelpCircle, LogOut, PlusCircle } from "lucide-react";
...
export default function Sidebar({ activeTab, onTabChange, onNewChat }: SidebarProps) {
  return (
    <aside className="w-[280px] h-screen fixed left-0 top-0 bg-mk9-slate border-r border-[#36424a]/20 flex flex-col z-50 text-white shadow-xl">
      {/* Brand logo container */}
      <div className="p-6 border-b border-[#36424a]/30">
        ...
        <p className="text-xs text-[#C9CBCB]/60 font-medium">CRM de Inteligência Operacional</p>
      </div>
      ...
      <div className="px-4 py-4">
        <button
          onClick={onNewChat}
          className="w-full bg-primary text-white font-semibold py-3 px-4 rounded-lg flex items-center justify-center gap-2 hover:bg-primary/90 transition-all active:scale-[0.98] shadow-md hover:shadow-primary/20 cursor-pointer"
        >
      ...
      <nav className="flex-1 px-3 space-y-1">
        ...
        <button
          ...
          className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition-all text-left cursor-pointer ${
            activeTab === "dashboard"
